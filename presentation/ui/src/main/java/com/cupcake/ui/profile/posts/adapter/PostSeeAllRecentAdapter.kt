...
class PostSeeAllRecentAdapter  (items: List<ProfilePostItemUIState>, listener: PostProfileInterAction,
) : BaseAdapter<ProfilePostItemUIState>(items, listener) {
    override var layoutId: Int = R.layout.item_profile_see_all_recent_post }